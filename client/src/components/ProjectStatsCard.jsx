export default function ProjectStatsCard({ projectData, milestonesData }) {
  return (
    <div className="bg-primary-bg rounded-md px-4 py-6 shadow-md text-white flex-1 h-full flex flex-col">
      <small className="uppercase">Overall Progress</small>
      <div>
        <div className="text-9xl bg-linear-60 from-secondary-bg to-chartreuse-100 bg-clip-text text-transparent font-bold">
